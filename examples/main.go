...
func main() {
	goth.UseProviders(
		...
		xero2.New(os.Getenv("XERO_KEY"), os.Getenv("XERO_SECRET"), "http://localhost:3000/auth/xero2/callback", xero2.ScopeOpenID, xero2.ScopeProfile, xero2.ScopeEmail, xero2.ScopeOfflineAccess, xero2.ScopeAccountingSettingsRead),
